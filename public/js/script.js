...
function addVideoStream(video, stream, peerId, user, adminId) {
  ...
  micBtn.innerHTML = `<ion-icon name="mic-off"></ion-icon>`;
  ...
  videoOffIndicator.innerHTML = `<ion-icon name="videocam"></ion-icon>`;
...
shareScreenBtn.addEventListener("click", (e) => {
  ...
  e.target.setAttribute("tool_tip", "You are presenting your screen");
...
micToggleButton.addEventListener("click", (e) => {
  ...
  if (enabled) {
    ...
    currentElement.innerHTML = `<ion-icon name="mic-off"></ion-icon>`;
